...
class QuestionTest < ActiveSupport::TestCase
  ...
  test 'search' do
    ...
    assert_equal questions('10111').dimension, @question.dimension
    assert_equal questions('10111').code, @question.code
    assert_equal questions('10111').question, @question.question
  end
  ...
  test 'validates unique attributes' do
    @question.code = questions('10113').code
    assert @question.invalid?
